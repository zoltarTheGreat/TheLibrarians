...
$inpreservedate = isset($_POST['inpreservedate']) ? $_POST['inpreservedate'] : '';
...
<body>
 ...
 <br/>
 <br>
 Reserve Date YYYY-MM-DD: <input type="date" name="inpreservedate" size="30" value="$inpreservedate">
 <br/>
 <br>
...
_HTML_;
  ...
  $querystring = "INSERT INTO reservebook (isbn,title,studentid,returnbook,flname) VALUES ('$inpisbn', '$inptitle','$inpstudentid','$inpreservedate','$inpflname')";
